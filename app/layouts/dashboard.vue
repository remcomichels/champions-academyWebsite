<template>
	<div id="pageContainer" class="dashLayout" :class="{ 'is-collapsed': collapsed }">
		...
		<div class="dashLayout-body">
			...
			<main id="main" tabindex="-1" class="dashLayout-main">
				<!-- An admin-only login has no affiliate profile, so there are no
				     ...
				     lives in the layout rather than in six pages, and Admin is
				     exempt because that is the one route such a login is for. -->
